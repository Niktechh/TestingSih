...
const Page = () => {
  ...
  return (
    <div><div
    >
      {/* <PlaceholderPage title="Yield Predictions" description="AI-powered crop yield forecasts with detailed charts and influencing factors." /> */}
        <div className="relative flex size-full min-h-screen flex-col bg-white group/design-root overflow-x-hidden">
      <div className="layout-container flex h-full grow flex-col">

        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col w-[512px]  py-5  flex-1">
            <h2 className="text-[#121712] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">{t("pred.title")}</h2>
            <div className="flex flex-col gap-3 p-4">
              <div className="flex gap-6 justify-between"><p className="text-[#121712] text-base font-medium leading-normal">{t("pred.step")}</p></div>
  ...
  <div className="h-2 rounded bg-[#121712]" style={{ width: "25%" }}></div>
            ...
            <h3 className="text-[#121712] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4">{t("pred.select_crop")}</h3>
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dde4dd] bg-white p-4 flex-col">
        ...
        <PopoverContent className="w-auto overflow-hidden p-0" align="start">
          ...
          />
            ...
            <div className="flex px-4 py-3">
              <button
                className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 flex-1 bg-[#218321] text-white text-sm font-bold leading-normal tracking-[0.015em]"
              >
